...
SEARCH_PROJECTS_VIEWS_TIP = _("Search Projects Views")
SEARCH_SOLUTIONS_VIEWS_TIP = _("Search Solutions Views")
SEARCH_SELLING_POINTS_VIEWS_TIP = _("Search Solutions Views")
SEARCH_BROCHURES_VIEWS_TIP = _("Search Brochures Views")
SEARCH_ORDERS_VIEWS_TIP = _("Search Orders Views")
...
ORDERS_VIEWS_TITLE = _("Uniseal Dashboard - Orders Reports Views ")
...
EMPTY_SEARCH_PHRASE_PROJECTS_VIEWS = _("Please enter project name then search!")
EMPTY_SEARCH_PHRASE_SOLUTIONS_VIEWS = _("Please enter solution title then search!")
EMPTY_SEARCH_PHRASE_SELLING_POINTS_VIEWS = _("Please enter solution title then search!")
EMPTY_SEARCH_PHRASE_BROCHURES_VIEWS = _("Please enter brochures title then search!")
EMPTY_SEARCH_PHRASE_ORDERS_VIEWS = _("Please enter orders title then search!")
EMPTY_SEARCH_PHRASE_PRODUCTS_PAGE_VIEWS = _("Please enter visiting date or month or year and select search by!")