...
//    $("ol.breadcrumb").css("background-color","#4a4a4a");
//    $("li.breadcrumb-item.active").css("color","#fff");
//    $("body").css("background-color","#24292e");
//    $("h1").css("color","#fff");
//    $("p").css("color","#fff");
...
//    $("ol.breadcrumb").css("background-color","#fff");
//    $("li.breadcrumb-item.active").css("color","#333");
//    $("body").css("background-color","#fff");
//    $("h1").css("color","#24292e");
//    $("p").css("color","#24292e");
