...
urlpatterns = [
    ...
    path('editApprovals', approval_views.ApprovalsListView.as_view(template_name ="approvals/edit_approvals.html", active_flag="edit_approvals", title=EDIT_APPROVALS_TITLE), name='editApprovals'),
