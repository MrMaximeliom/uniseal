...
from apps.address import area_dashboard_views as area_dashboard_views
from apps.address import state_dashboard_views as state_dashboard_views, city_dashboard_views as city_dashboard_views, \
    country_dashboard_views as country_dashboard_views
